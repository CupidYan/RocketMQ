...
public class ServerMQTT {
    ...
    public MqttTopic getTopic2() {
		return topic2;
	}

	public void setTopic2(MqttTopic topic2) {
		this.topic2 = topic2;
	}
    ...
    private static final String clientid = "mqtt_server11";
   ...
   /* public static void main(String[] args) throws MqttException {
        ...
        server.message.setPayload("hello,cupid".getBytes());
